...
class SwitchClanScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.info = pygame_gui.elements.UITextBox(
            'Note: This will close the game.\n When you open it next, it should have the new Mischief.',
        ...
        if game.clan:
            self.current_clan.set_text(
                f"The currently loaded Mischief is {game.clan.name}Mischief")
        else:
            self.current_clan.set_text("There is no Mischief currently loaded.")
